...
class VPGBuffer:
    ...
    def end_traj(self, last_val=0):
        ...
        # Dies wäre noch zu implementieren, wird dann beim value update verwendet. 
...
class Agent:
    ...
    def train(self):
        ...
        for epoch in range(epochs):
            ...
            for _ in range(100):
                ...
                #v_optimizer.step()
                v_loss = ((self.ac.v.forward(obs) - ret)**2).mean() #Hier müssten wir eigentlich die "discounted rewards-to-go" benutzen
                #print(v_loss)
                v_loss.backward()
                v_optimizer.step() 
    ...
    def get_action(self, obs):
        ...
        return a #np.random.choice([0, 1, 2, 3])
