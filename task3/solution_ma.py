...
class BO_algo():
    ...
    def add_data_point(self, x, f, v):
        ...
        self.y = np.vstack((self.y,f+np.random.normal(0,self.sigma_f_noise))) # TODO Hier müssen wir prüfen ob wirklich hier der Noise zugefügt wird
